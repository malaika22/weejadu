                    ...
                    <Grid item md={10} xs={12}>
                        <div className="home-banner-container">
                            ...
                            <div className="banner-footer">
                                <div className="jadu-title"><span className="do-span">Do</span><span className="jadu-span">Jadu</span><ArrowRight className="arrow-right-icon"/></div>
                                <div className="footer-content">
                                    <div className="upper-content">CHALLENGES THAT UP TO YOUR SKILLS</div>
                                    <div className="bottom-content">Take challenge &amp; win prize every week (top 3 response)</div>
                                </div>
                            </div>  
                        </div>
                    </Grid>
                                ...
                                <Grid container>
                                    ...
                                    <div className="sponsor-div">
                                            ...
                                            <div className="option">
                                                ...
                                                <span className="icon-span"><ArrowForwardIosOutlined /></span>
                                            </div>
                                            ...
                                            <div className="options-situation">for Cadilla Medical Represeentatives</div>
                                                ...
                                                <Grid item md={9} sm={9} xs={12}>
                                                    <div className="option-tab">
                                                        <div className="option">
                                                            ...
                                                            <span className="icon-span"><ArrowForwardIosOutlined /></span></div>
                                                        <div className="options-situation">{option?.situations} situations</div>
                                                    </div>
                                                </Grid>
                                        </Grid>
                                    </div>
